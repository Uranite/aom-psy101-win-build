...
However, the contents of this repository itself (i.e., the build script) are licensed under the MIT License. See the [LICENSE](https://github.com/Uranite/aom-psy101-win-build/blob/master/LICENSE) file for more information.